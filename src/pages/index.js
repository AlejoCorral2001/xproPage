  ...
  return (
    <Layout type={'index'}>
      ...
      <section className="pt-5 md:pt-20">
        <div className="mb-20">
          <h1 className="text-5xl font-bold leading-none text-center lg:text-6xl xl:text-6xl">
            X-PRO
          </h1>
          <p className="text-2xl text-center lg:text-3xl xl:text-4xl text-primary-darker">CNCs</p>
          <p className="pt-4 text-center lg:text-2xl xl:text-3xl text-primary">
            Fabricantes de routers numéricos
          </p>
        </div>
        <div className="container px-8 mx-auto lg:flex">
          <div className="text-center lg:text-left lg:w-1/2">
            ...
            <p className="mt-6 text-xl font-light lg:text-2xl">
              Junto a la compra de cualquier router cnc estan incluidos videos de capacitacion para
              poder comenzar a explotar tus ideas en tan solo unas horas
            </p>
            <p className="mt-8 md:mt-12">
              <Button size="lg" className="m-4 text-lg" link={'/catalogue'}>
                Catálogo
              </Button>
              <Button size="lg" className="m-4 text-lg" link={'/examples'} color={'red'}>
                Ejemplos
              </Button>
            </p>
      ...
      <section id="features" className="py-20 lg:pb-40 lg:pt-48">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-semibold lg:text-5xl">En X-PRO CNCs ofrecemos</h2>
          <div className="flex flex-col mt-12 sm:flex-row sm:-mx-3">
            <div className="flex-1 px-3">
              <Card className="mb-8">
                <p className="text-xl font-semibold">Mejores precios del mercado</p>
                <p className="mt-4">
                  Actualmente estamos manejando los precios más bajos del mercado sin sacrificar la
                  durabilidad y calidad de nuestros productos.
                </p>
              </Card>
            </div>
            <div className="flex-1 px-3">
              <Card className="mb-8">
                <p className="text-xl font-semibold">Calidad en todo sentido</p>
                <p className="mt-4">
                  Utilizamos materiales de alta resistencia para asegurar la durabilidad y buen
            ...
            <div className="flex-1 px-3">
              <Card className="mb-8">
                <p className="text-xl font-semibold">Lista para usar</p>
                <p className="mt-4">
